...
The trained model is available for download in the Releases section. To run the App, download the dataset and the trained model in your local repository and run 'streamlit run App.py' in the terminal.
